...
try{
 ...
 const cases=[['Landing',Landing,{onStart:noop}],['WorkspaceShell',WorkspaceShell,{view:'dashboard',notifyEnabled:true,onHome:noop,onDashboard:noop,onNewProject:noop,onToggleNotify:noop}],['Dashboard',Dashboard,{onNewProject:noop,onOpenProject:noop,notifyEnabled:true,alerts:flow.SIMILAR_ANNOUNCEMENT_ALERTS,isNewUser:false,onToggleNewUser:noop}],['EmptyDashboard',Dashboard,{onNewProject:noop,onOpenProject:noop,notifyEnabled:false,alerts:[],isNewUser:true,onToggleNewUser:noop}],...['IntakeForm','MatchProgress','MatchResults','EligibilityGate','PlanForm','ArtifactResult','FinalVerdict','ReviewScreen'].map(name=>[name,flow[name],shared])];
