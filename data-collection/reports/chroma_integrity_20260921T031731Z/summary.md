...
- 실행: 2026-09-21T03:17:28+00:00 → 2026-09-21T03:17:31+00:00
...
- 판정: 불일치
- NPZ 2328건 · Chroma 2328건 · 비교 2328건 · 바이트 일치 1775건
- 최대 절대 차이 0.0193024 (허용 1e-06, float32)
- 허용 오차 근거: float32 → .tolist() → Chroma float32 왕복은 정확해야 한다. 1e-6 은 float32 반올림 1회보다 크고 서로 다른 벡터의 차이보다 훨씬 작다.
- 벡터 값이 허용 오차(1e-06)를 넘게 다른 공고 1건
  - `kstartup:179193` 최대 차이 0.0193024
